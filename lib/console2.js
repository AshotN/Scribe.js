(function () {
    ...
    var Console2 = function (opt) {
        ...
        this.opt = {
            ...
            alwaysDuration: opt.alwaysDuration === true,
    ...
    Console2.prototype.duration = Console2.prototype.d = function (duration) {
    ...
    Console2.prototype.addLogger = function (name, colors, opt) {
        ...
        opt.alwaysDuration = opt.alwaysDuration || this.opt.alwaysDuration;
        ...
        this[name] = function () {
            ...
            var log = {
                ...
                show: {
                    ...
                    duration: this.opt.alwaysDuration || this._duration
                },
                context: {
